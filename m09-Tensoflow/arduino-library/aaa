...
//   Serial.println("  interpreter.get_input_details(): " + String(input_tensor) );
 ...
 String myTensorType = "Int ??"; 
 if (myType == 2){myTensorType = "float??"; }  
 if (myType == 3){myTensorType = "Text??"; }  
   ...
   for (int i = 0; i < mySize; i++) {
     ...
     Serial.print( "            input->dims->data[" );
     Serial.print( String(i) );
     Serial.print( "]: " );
     Serial.println(  String(myIn) );
   }

   Serial.println(  );
   int myType2 =  output->type; 
   String myTensorType2 = "Int ??"; 
   if (myType2 == 2){myTensorType2 = "float??"; }  
   if (myType2 == 3){myTensorType2 = "Text??"; }  
   ...
   for (int i = 0; i < mySize2; i++) {
     int myIn = output->dims->data[i];  
     Serial.print( "            output->dims->data[" );
     Serial.print( String(i) );
     Serial.print( "]: " );
     Serial.println(  String(myIn) );
   }
