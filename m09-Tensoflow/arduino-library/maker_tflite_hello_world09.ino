...
*/
  ...
  float y_val = output->data.f[0];
   ...
   Serial.println("                           x_val: " + String(x_val) ); 
   Serial.println("                            yval: " + String(y_val) ); 
   Serial.println(); 
   
   Serial.println("            input->dims->data[0]: " + String(input->dims->data[0]) );
   Serial.println("                     input->type: " + String(input->type) );
   Serial.println("               input->dims->size: " + String(input->dims->size) );
   Serial.println("            input->dims->data[1]: " + String(input->dims->data[1]) );
