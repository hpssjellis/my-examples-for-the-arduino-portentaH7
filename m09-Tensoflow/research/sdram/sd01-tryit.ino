...
uint8_t *sdram_model_tflite;    // actually unsigned Char  but should be the same size ?
...
void setup() {
   ...
   sdram_model_tflite = (uint8_t *)mySDRAM.malloc(model_tflite_len * sizeof(uint8_t));  // actually unsigned char but should be same size
