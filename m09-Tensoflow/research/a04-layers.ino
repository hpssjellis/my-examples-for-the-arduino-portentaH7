...
//#define TENSOR_ARENA_SIZE 432*1024    // fine on the Arduino Portenta Not much memory for other things

#define TENSOR_ARENA_SIZE 20*1024       // fine on the Seeeduino XIAO Not much memory for other things
                                        // Note 3 x 100 node layers max on Seeeduino XIAO
