...
// Start Debug.cc information    ----------------------------------------------------------
 ...
 // Note: CORE_CM4, NANO_33_BLE deprecated as MBED of 1.30, new names: PORTENTA_H7_M4 see above for Nano33BLE   
  ...
  #elif defined (TEENSYDUINO)  ||  defined (YOUR_BOARD4) // Arduino UNO style boards
  extern "C" void DebugLog(const char* s) {
     Serial.print(s);
  }

 #elif defined (SEEED_XIAO_M0)  ||  defined (YOUR_BOARD5) // The new $5 USD Seeeduino XIAO board
