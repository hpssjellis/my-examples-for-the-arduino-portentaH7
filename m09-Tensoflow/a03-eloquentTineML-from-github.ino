 ...
 * uses the EloquentTinyML library put loaded from the github site
 * Uses a new version
 * extract or git clone the github at https://github.com/eloquentarduino/EloquentTinyML 
 * 
 * put it in your documents/arduino/libraries l0cation
 *
 *
