...
int x1, x2, x3, x4;  // short term data store
...
void loop() {
  ...
  if (client) {                             // if you get a client,
    ...
    int x2 = analogRead(A2);                // read A2
    int x3 = analogRead(A3);                // read A3
    int x4 = analogRead(A4);                // read A4
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
           ...
           //client.println("{answer:42}");
            ...
            client.print("<br> AnalogRead(A1); = "+ String(buffer1) );        
            client.print("<br> AnalogRead(A2); = "+ String(buffer2) );        
            client.print("<br> AnalogRead(A3); = "+ String(buffer3) );        
            client.print("<br> AnalogRead(A4); = "+ String(buffer4) );        
            client.print("<br> The Data Buffer to store on the SD Card contains: " );    
            client.print(buffer);
