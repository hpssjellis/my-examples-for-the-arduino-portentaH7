...
String appEui = "81190DD3CA7FB3DB";    // get from https://console.helium.com/devices
String appKey = "5E2517696E120E7622BA43DDC005E0BE";  // you have to change this from https://console.helium.com/devices
...
void loop() {
  ...
  // For North American basic connections MAYBE???
    ...
    delay(3660000);  // 1000 = 1 second, then 3660000 = 1 hour, 7320000 = every 2 hours
