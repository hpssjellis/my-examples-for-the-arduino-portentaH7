...
void setup(){
    ...
    myNet.get_ip_address(&myAddress);
    Serial.println("IP address: " + String(myAddress.get_ip_address() ? myAddress.get_ip_address() : "None") );
    Serial.println();
    // Open a socket on the network interface, and create a TCP connection to mbed.org
    TCPSocket mySocket;
    mySocket.open(&myNet);

    myNet.gethostbyname("ifconfig.io", &myAddress);
    myAddress.set_port(80);
